ServerEvents.recipes(event => {
	...
	//EIO-ALLOY-UPGRADE
	event.replaceInput({ output: 'enderio:alloy_smelter', type: 'minecraft:crafting_shaped' }, 
		'enderio:void_chassis', 
		'enderio:primitive_alloy_smelter'
		)
	
	//HOPPER-BOTANYPOTS
	event.replaceInput({ id: '/botanypots:botanypots/crafting/.+_hopper_botany_pot/' }, 
		'minecraft:hopper',
		'botania:hopperhock_chibi'
		)
	event.replaceInput({ id: '/botanypots:botanypots/crafting/.+_compact_hopper_botany_pot/' }, 
		'minecraft:hopper',
		'botania:hopperhock_chibi'
		)
		
	//AC-URANIUM
	event.replaceInput({ output: 'alexscaves:nuclear_bomb', type: 'minecraft:crafting_shaped' }, 
		'#forge:storage_blocks/uranium', 
		'alexscaves:block_of_uranium'
		)
	event.replaceInput({ output: 'alexscaves:nuclear_furnace_component', type: 'minecraft:crafting_shaped' }, 
